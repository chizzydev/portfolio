              ...
              {contactInfo.map(contact => {
                ...
                return (
                  <Card
                    ...
                    onClick={() => contact.href && (window.location.href = contact.href)}
                  >
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      {contact.copyable && (
                        <button
                          ...
                          className={`flex-shrink-0 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${
                            isCopied 
