export const experience = [
...

  {
    ...
    company: 'Skillsroom - Competitive Gaming Platform',
    location: 'Global',
    locationType: 'Remote',
    startDate: '2026-06',
    endDate: 'Present',
    current: true,
    description: 'Built a live competitive gaming platform that combines match rooms, tournaments, messaging, community identity, public winner pages, admin operations, and trust-oriented review flows in one product.',
    responsibilities: [
      'Designed and shipped the product across public marketing pages, signed-in player flows, match rooms, tournaments, community pages, inbox, and admin operations surfaces',
      'Built the messaging layer for global chat, game channels, direct messages, DM requests, media sharing, reactions, search, and attachment handling',
      'Implemented room and tournament trust flows covering funding review, result evidence, disputes, moderation paths, settlement queues, and public-safe winner pages',
      'Added public leaderboards, clan pages, announcements, winner highlights, and platform metrics so the community side feels active instead of empty',
      'Improved mobile responsiveness and product quality through repeated layout hardening, wording cleanup, premium visual direction, and cross-surface UX fixes',
    ],
    techStack: [
      'Next.js',
      'React',
    ...
    highlights: [
      'Shipped a live platform that handles rooms, tournaments, messaging, moderation, and public discovery in one connected system',
      'Solved difficult mobile DM/media layout issues and hardened chat behavior across attachment-heavy flows',
      'Built richer public-facing product pages so the platform looks like a real gaming product rather than a backend-heavy utility',
      'Connected player-facing trust, admin review, and public outcome visibility without exposing private operational detail',
    ],
    companyUrl: 'https://skillsroom.xyz/',
    companyLogo: null,
  },

  {
    id: 'proofcairn-platform',
    type: 'project',
    title: 'Founder / Product Engineer',
    company: 'ProofCairn - Trust, Security, and Market Intelligence',
    location: 'Global',
    locationType: 'Remote',
    startDate: '2026-05',
    endDate: 'Present',
    current: true,
    description: 'Built and launched a live trust, security, conversion, and market-intelligence platform that helps digital businesses understand competitor movement, public trust gaps, exposed routes, weak headers, and other visible signals that can affect buyer confidence.',
    responsibilities: [
      'Designed the product positioning, public website, sample reports, lead capture, checkout flows, admin workspace, and delivery operations',
      'Built the Trust Audit and Security Exposure Engine around passive public checks, route intelligence, redacted evidence, security headers, cookies, CSP quality, robots/sitemap signals, and manual validation guidance',
      'Implemented Rival Brief workflows for competitor monitoring across ecommerce, SaaS, apps, services, marketplaces, and content businesses',
      'Added PDF generation, Supabase Storage artifacts, signed hosted reports, client-ready evidence, payment lifecycle logic, alerting, incident queues, and operational health checks',
      'Hardened owner/admin access with invite-only auth, Google SSO, passkeys, session expiry, revocation controls, CSRF/origin checks, and audit logs',
    ],
    techStack: [
      'Next.js',
      'React',
    ...
    highlights: [
      'Shipped proofcairn.com as a live product rather than a portfolio-only demo',
      'Built a safe, business-aware security review engine that avoids unauthorized exploitation while surfacing real public exposure signals',
      'Created a premium report system that translates technical findings into plain-English business risk and next steps',
      'Implemented production readiness across payments, alerts, health checks, admin controls, PDFs, and operational workflows',
    ],
    companyUrl: 'https://proofcairn.com/',
    companyLogo: null,
  },
